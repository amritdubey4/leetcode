"""
LeetCode Q80: Remove Duplicates from Sorted Array II
...
Since it is impossible to change the size of the array in some languages, you must instead have the result 
